    ...
    const books = [
      {
        ...
        genre: ["Fantasy"],
        price: 199,
        coverImage: "http://localhost:5000/uploads/The%20Hidden%20Gate.webp",
        stock: 50,
        ratings: 4.5,
      },
      {
        ...
        genre: ["Sci-Fi"],
        price: 249,
        coverImage: "http://localhost:5000/uploads/Beyond%20the%20Binary.webp",
        stock: 40,
        ratings: 4.7,
      },
      {
        ...
        price: 179,
        coverImage: "http://localhost:5000/uploads/Echoes%20of%20Dust.webp",
        stock: 35,
        ratings: 4.3,
      },
      {
        ...
        genre: ["Thriller"],
        price: 229,
        coverImage: "http://localhost:5000/uploads/The%20Lighthouse%20Code.webp",
        stock: 45,
        ratings: 4.6,
      },
      {
        ...
        genre: ["Thriller"],
        price: 189,
        coverImage: "http://localhost:5000/uploads/The%20Scripted%20Revolt.webp",
        stock: 60,
        ratings: 4.4,
      },
      {
        ...
        price: 259,
        coverImage: "http://localhost:5000/uploads/The%20Astral%20Code.webp",
        stock: 38,
        ratings: 4.8,
      },
      {
        ...
        price: 139,
        coverImage: "http://localhost:5000/uploads/Salt%20in%20the%20Wind.webp",
        stock: 30,
        ratings: 4.1,
      },
      {
        ...
        genre: ["Fantasy"],
        price: 219,
        coverImage: "http://localhost:5000/uploads/The%20Iron%20Prophet.webp",
        stock: 50,
        ratings: 4.5,
      },
      {
        ...
        genre: ["Adventure", "Fiction"],
        price: 209,
        coverImage: "http://localhost:5000/uploads/The%20Green%20Archive.webp",
        stock: 32,
        ratings: 4.2,
      },
      {
        ...
        genre: ["Thriller"],
        price: 269,
        coverImage: "http://localhost:5000/uploads/Phantom%20Code.webp",
        stock: 40,
        ratings: 4.7,
      },
      {
        ...
        genre: ["Adventure"],
        price: 199,
        coverImage: "http://localhost:5000/uploads/Waves%20of%20Time.webp",
        stock: 28,
        ratings: 4.3,
      },
      {
        ...
        genre: ["Fantasy"],
        price: 179,
        coverImage: "http://localhost:5000/uploads/Clay%20and%20Smoke.webp",
        stock: 45,
        ratings: 4.4,
      },
      {
        ...
        price: 189,
        coverImage: "http://localhost:5000/uploads/The%20Mercury%20Plan.webp",
        stock: 36,
        ratings: 4.5,
      },
      {
        ...
        genre: ["Sci-Fi", "Mystery"],
        price: 249,
        coverImage: "http://localhost:5000/uploads/City%20of%20Ciphers.webp",
        stock: 39,
        ratings: 4.6,
      },
      {
        ...
        price: 159,
        coverImage: "http://localhost:5000/uploads/Breakpoint%20Delta.webp",
        stock: 34,
        ratings: 4.2,
      }
    ];
